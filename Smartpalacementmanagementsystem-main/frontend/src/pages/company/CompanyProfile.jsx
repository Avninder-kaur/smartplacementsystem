        ...
        <div className="bg-card border rounded-xl p-6 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              {companySizes.map((size) => (<button key={size} type="button" onClick={() => setCompanySize(size)} className={`px-3 py-1.5 rounded-lg text-sm border transition-all ${companySize === size
          ...
          <div className="space-y-2">
            ...
            <Textarea placeholder="Tell students about your company, culture, and what makes it a great place to work..." rows={4} defaultValue="TechCorp is a leading technology company specializing in cloud solutions and enterprise software. We believe in a culture of innovation, collaboration, and continuous learning."/>
          </div>
        </div>
