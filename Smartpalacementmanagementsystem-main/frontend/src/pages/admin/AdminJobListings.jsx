...
import { LayoutDashboard, Users, Building2, Briefcase, FileText, Search, } from "lucide-react";
...
export default function AdminJobListings() {
    ...
    const filtered = allJobs.filter((j) => j.title.toLowerCase().includes(search.toLowerCase()) ||
      ...
      <div className="bg-card border rounded-xl overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody>
              {filtered.map((job) => (<tr key={job.id} className="border-b last:border-0 hover:bg-muted/30 transition-colors">
