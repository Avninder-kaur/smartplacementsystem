...
export default function Login() {
    ...
    const redirectByRole = (nextRole) => {
        ...
        else if (nextRole === "recruiter" || nextRole === "company")
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            const actualRole = response.user?.role || role;
            if (response.user?.role && response.user.role !== role) {
                toast(`Logged in as ${response.user.role}. Redirecting to your ${response.user.role} dashboard.`);
            }
